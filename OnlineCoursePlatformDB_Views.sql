...
-- Maurice Hazan
-- July 13, 2025
-- 6 Reports with Views, to be used in Python intranet built UI web reporting to display these views with cards, charts, tables, and interactive dashboards.
-- ============================================================================================================================================================
...
CREATE VIEW vw_CourseLicensingRevenue AS
SELECT 
...
CREATE VIEW vw_TopStudentAchievements AS
SELECT 
    u.FullName,
...
CREATE VIEW vw_UserLearningEngagementSummary AS
SELECT 
    u.FullName,
...
CREATE VIEW vw_ActiveStudentEngagement AS
SELECT 
    u.FullName,
...
CREATE VIEW vw_CourseCompletionStats AS
SELECT 
    c.Title AS CourseTitle,
...
CREATE VIEW vw_SupportPerformanceMetrics AS
SELECT 
